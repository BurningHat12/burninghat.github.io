...
const experiences = [
  ...
  },
  {
    ...
    points: [
      "Implementing security measures such as data validation, encryption, and authentication to protect web applications from security threats.",
      "Working with a diverse set of technologies, including HTML, CSS, JavaScript, PHP, Python, Ruby, or other relevant languages and frameworks.",
